...
void PathSolution::update(void)
{
    ...
    //std::cout << "Source: " << source.x << ", " << source.y << ", " << source.z <<std::endl;
    //std::cout << "Listener: " << target.x << ", " << target.y << ", " << target.z <<std::endl;
    // Clear all paths
    m_paths.clear();
    ...
    //std::cout << "Number of Paths: " << m_paths.size() << std::endl;
    /*
